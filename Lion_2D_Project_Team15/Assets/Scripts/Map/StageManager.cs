...
public class StageManager : MonoBehaviour
{
    ...
    public void TeleportToPortal(int targetIndex)
    {
        ...
        #region 나중에 지워야할 것
        player.GetComponent<move>().currentMap = targetPortal.MapIndex; // 이동할 맵의 인덱스로
        Camera.main.GetComponent<followcam>().transCam(targetPortal.MapIndex); // 카메라 이동
        #endregion
    }
